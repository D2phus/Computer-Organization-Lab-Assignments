...
HD_PWD='E:/package_28/package_28.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log package.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source package.tcl -notrace
