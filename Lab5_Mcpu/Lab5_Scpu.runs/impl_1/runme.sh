...
HD_PWD='D:/Vivado/Lab5_Mcpu/Lab5_Scpu.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log minisys.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source minisys.tcl -notrace
